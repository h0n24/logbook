...
function filterScripts(scriptsArray) {
    let filteredScriptsArray = [];
    ...
    for (let i = 0; i < scriptsArray.length; i++) {
        ...
        if (scriptsArray[i].startsWith("https://cdnjs.cloudflare.com/ajax/libs/angular-material")) {
            continue;
        }
...
async function downloadTestZip(arrayOfScripts) {
...
export function findScripts() {
    let scriptsArray = getAllScriptsLinks();
    ...
    let filteredScriptsArray = filterScripts(scriptsArray);
